...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/datasource')) {
            ...
            if (0 === strpos($pathinfo, '/datasource/add')) {
                // ds_default_add
                ...
                if (0 === strpos($pathinfo, '/datasource/add/step')) {
                    // ds_default_stp1
                    if ($pathinfo === '/datasource/add/step1') {
                        return array (  '_controller' => 'DataSourceBundle\\Controller\\DefaultController::step1Action',  '_route' => 'ds_default_stp1',);
                    }

                    // ds_default_stp2
                    if (0 === strpos($pathinfo, '/datasource/add/step2') && preg_match('#^/datasource/add/step2/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ds_default_stp2')), array (  '_controller' => 'DataSourceBundle\\Controller\\DefaultController::step2Action',));
                    }

                    // ds_default_stp3
                    if (0 === strpos($pathinfo, '/datasource/add/step3') && preg_match('#^/datasource/add/step3/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'ds_default_stp3')), array (  '_controller' => 'DataSourceBundle\\Controller\\DefaultController::step3Action',));
                    }
        ...
        if (0 === strpos($pathinfo, '/log')) {
            if (0 === strpos($pathinfo, '/login')) {
                ...
                if ($pathinfo === '/login') {
                    ...
                    return array (  '_controller' => 'AdminBundle\\Controller\\SecurityController::loginAction',  '_route' => 'fos_user_security_login',);
                }
                ...
                if ($pathinfo === '/login_check') {
                    ...
                    return array (  '_controller' => 'AdminBundle\\Controller\\SecurityController::checkAction',  '_route' => 'fos_user_security_check',);
                }
            ...
            if ($pathinfo === '/logout') {
                ...
                return array (  '_controller' => 'AdminBundle\\Controller\\SecurityController::logoutAction',  '_route' => 'fos_user_security_logout',);
            }
