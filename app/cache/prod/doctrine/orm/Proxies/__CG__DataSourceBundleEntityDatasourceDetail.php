 ...
 */
class DatasourceDetail extends \DataSourceBundle\Entity\DatasourceDetail implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'DataSourceBundle\\Entity\\DatasourceDetail' . "\0" . 'id', '' . "\0" . 'DataSourceBundle\\Entity\\DatasourceDetail' . "\0" . 'name', '' . "\0" . 'DataSourceBundle\\Entity\\DatasourceDetail' . "\0" . 'date', '' . "\0" . 'DataSourceBundle\\Entity\\DatasourceDetail' . "\0" . 'type', '' . "\0" . 'DataSourceBundle\\Entity\\DatasourceDetail' . "\0" . 'rank', '' . "\0" . 'DataSourceBundle\\Entity\\DatasourceDetail' . "\0" . 'enabled', '' . "\0" . 'DataSourceBundle\\Entity\\DatasourceDetail' . "\0" . 'datasource');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DatasourceDetail $proxy) {
